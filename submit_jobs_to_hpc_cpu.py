# *- coding: utf-8 -*-
"""
Suppoese you are submitting jobs to HPS managed by SLURM, you can use this script to submit multiple jobs to HPC.
"""
...
def main():
    ...
    # submit you data jobs to HPC - CPU
    for data in data_list:
        for network, network_gene in zip(network_list, network_gene_list):
            ...
            command = (
                ...
                f"run_on_hpc_cpu.sh {input_dir_path} {network_dir_path} {cur_output_dir_path} "
